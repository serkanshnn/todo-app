<template>
    <div>
        <div class="w-full">
            <div class="flex flex-col w-3/5 mx-auto mt-12">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 tracking-wider">
                                        <a href="/todos/create" class="relative inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                            Create new task
                                        </a>
                                    </th>
                                </tr>
