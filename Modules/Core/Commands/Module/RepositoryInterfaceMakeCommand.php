...
class RepositoryInterfaceMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-repositoryinterface';
     ...
     * @var string
     */
    protected $description = 'Generate new Repository Interface for the specified module.';
    ...
    {
        return str_replace('RepositoryInterface', '', $this->getRepositoryNameWithoutNamespace());
    }
    ...
    protected function getRepositoryName()
    {
        ...
        if (Str::contains(strtolower($repository), 'repositoryinterface') === false) {
    ...
    {
        $stub = '/Repositories/RepositoryInterface.stub';
