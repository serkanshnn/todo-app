...
class ServiceInterfaceMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-serviceinterface';
     ...
     * @var string
     */
    protected $description = 'Generate new Service Interface for the specified module.';
    ...
    {
        return str_replace('ServiceInterface', '', $this->getServiceNameWithoutNamespace());
    }
    ...
    protected function getServiceName()
    {
        ...
        if (Str::contains(strtolower($repository), 'serviceinterface') === false) {
    ...
    {
        $stub = '/Service/ServiceInterface.stub';
