...
return [
    ...
    */
    ...
    'stubs' => [
        'enabled' => true,
        'path' => module_path('Core').'/stubs',
        // directly copy necessary files by replacing the variables with the contents of the associated replacement array
        'files' => [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            // Modules - Core Addons
            'transformers' => ['path' => 'Transformers', 'generate' => false],
            'dto' => ['path' => 'DTO', 'generate' => true],
            'nova' => ['path' => 'Nova', 'generate' => true],
